...
const categoryButton =
  "grid min-h-[42px] w-full cursor-pointer grid-cols-[25px_1fr_24px_16px] items-center rounded bg-transparent px-2 py-1 text-left text-[13px] font-semibold text-[#4f5852] hover:bg-[#e8ede8] dark:text-[#c4cdc6] dark:hover:bg-surface-hover-dark";
const sidebarPanel =
...
const sidebarLink =
  "grid min-h-[34px] w-full cursor-pointer grid-cols-[minmax(0,1fr)_auto_7px] items-center gap-2 rounded-[3px] px-[7px] py-[7px] pl-[9px] text-left font-mono text-xs leading-[1.45] hover:bg-[#eaf0e7] hover:text-[#303732] dark:hover:bg-surface-hover-dark dark:hover:text-[#e3e9e4]";
